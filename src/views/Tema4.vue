...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.my-5           
      .col-lg-10.bg2.p-4(data-aos="fade-left")
        .row.justify-content-center.align-items-center         
          ...
          .col
            p(data-aos="fade-down") Con el fin de ampliar el concepto de palabras claves o <i>Keywords</i> el siguiente video define los elementos que se deben tener presentes con esta herramienta:
            .tarjeta.color-acento-contenido.p-3
              .row.justify-content-around.align-items-center
                .col
                  .row.justify-content-between.align-items-center
                    .col.mb-3.mb-sm-0
                      p.mb-0.text-white El concepto de palabras claves o <i>Keywords</i>
                    .col-sm-auto
                      a.boton.color-acento-botones(href="https://youtu.be/-bbJONQgamY" target="_blank")
                        span Ver video
      ...
      .col-lg-7.my-3
        ...
        .bg5.p-5(data-aos="fade-left")
          .row.justify-content-center.align-items-center       
            ...
            .col
              ul.lista-ul.ps-1.mb-0
                li 
                  i.fas.fa-check.color-v1
                  p.mb-0 Dónde venden vehículos usados cerca de mi casa.
                li 
                  i.fas.fa-check.color-v1
                  p.mb-0 Venta de vehículos usados en Colombia.
                li 
                  i.fas.fa-check.color-v1
    ...
    .row.justify-content-center.align-items-center.mb-5           
      .col-lg-10
        .row.justify-content-center.align-items-start.mb-5.bg16.p-4(data-aos="fade-left")           
          .col-lg-6.br.my-3 
            h4.text-center Palabras claves genéricas
            ...
            p Ejemplos de <i>Keywords</i> genéricas: 
            ul.lista-ul.ps-1.mb-0
              li 
                i.fas.fa-check.color-v1
                p.mb-0 Apartamentos.
              ...
              li 
                ...
                p.mb-0 Colegios. 
          .col-lg-6.my-3 
            h4.text-center Palabras clave compuestas long tail
            ...
            p En muchos casos la competencia es menor, así que al posicionarnos con este tipo de <i>Keywords</i> podremos ver resultados con mayor facilidad. 

            p Algunos ejemplos de <i>Keywords</i> long tail:
            ul.lista-ul.ps-1.mb-0
              li 
                i.fas.fa-check.color-v1
                p.mb-0 Alquiler de apartamentos en Barranquilla.
              li 
                i.fas.fa-check.color-v1
                p.mb-0 Recetas con caviar.
              li 
                i.fas.fa-check.color-v1
                p.mb-0 Venta de casas en Colombia.
              li 
                i.fas.fa-check.color-v1
    ...
    TabsA.color-acento-contenido.mb-5
      .tarjeta.color-acento-botones.p-4(titulo="Investigación")
        .row
          ...
          .col-lg-4
            figure
              img(src='@/assets/curso/temas/90.png', style="width: 350px").m-auto   
      .tarjeta.color-acento-botones.p-4(titulo="Métricas")
        .row
          .col-lg-8.mb-4.mb-lg-0
            h4 Métricas
          ...
          .col-lg-4
            figure
              img(src='@/assets/curso/temas/91.png', style="width: 350px").m-auto  
      .tarjeta.color-acento-botones.p-4(titulo="Análisis")
        .row
          .col-lg-8.mb-4.mb-lg-0
            h4 Análisis
            p Deben analizarse los resultados de los datos y comenzar a seleccionar las palabras claves con mejor rendimiento o resultado. Por ejemplo, allí se puede apreciar que en los últimos meses, una palabra clave como “vehículos usados” puede tener una tendencia de búsqueda constante, pero que los picos más altos se ubican en ciertos meses, fechas en las que las personas en Colombia acostumbran vender su vehículo usado. 
          .col-lg-4
            figure
              img(src='@/assets/curso/temas/92.png', style="width: 350px").m-auto  
    p(data-aos="fade-down").mb-5 Hay que realizar esta actividad con diferentes palabras o frases clave para seleccionar aquellas que cumplan con estos criterios:
    ...
    .row.justify-content-center.align-items-center.mb-5      
      .col-lg-10.bg5.p-4(data-aos="flip-down")
        ul.lista-ul.ps-1.mb-0
          li 
            i.fas.fa-check.color-v1
            p.mb-0 Alto volumen de búsqueda: es preferible, que no se seleccionen porque son genéricas.

          li.mb-0 
            i.fas.fa-check.color-v1
            p.mb-0 Competencia baja: es decir, que no es genérica y por tanto, puede representar una oportunidad para posicionarla fácilmente con alguna estrategia de inversión en anuncios.
    p(data-aos="fade-down").mb-5 Estas dos cosas se deben tener en cuenta para la selección adecuada de las <i>Keywords</i>. Asimismo, esta estrategia debe integrarse con la investigación de la audiencia y sus hábitos de búsqueda de contenido; las palabras clave mal escritas no deben ser posicionadas.

    Separador 
    #t_4_2.titulo-segundo.color-acento-contenido(data-aos="zoom-in-left")
      h2 4.2 Herramientas de selección de <i>Keywords</i> 

    p(data-aos="fade-down").mb-5 Existen diversas herramientas para la búsqueda y selección de las palabras clave, algunas son de uso gratuito y otras requieren de suscripción o compra de licencia para su funcionamiento. Las siguientes herramientas agrupan las principales alternativas para la selección de palabras clave:
