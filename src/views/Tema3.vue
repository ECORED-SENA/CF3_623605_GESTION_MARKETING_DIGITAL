...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-3.justify-content-center.mb-5
      ...
      .col-12.col-lg-10.mb-3.h-100(data-aos="zoom-in")
        .row.bg8.justify-content-start
          ...
          .col-9.align-items-center.p-3
            div
              p.mb-0 Identifican aquellos aspectos que pueden “tocar la fibra sensible” del cliente y así, adaptar el producto de acuerdo con sus necesidades.
      ...
      .col-12.col-lg-10.mb-3.h-100(data-aos="zoom-in")
        .row.bg8.justify-content-start
          ...
          .col-9.align-items-center.p-3
            div
              p.mb-0 Es un aspecto no tangible de la marca, por lo que lleva a la generación de ideas innovadoras y disruptivas con los equipos de trabajo. 
      ...
      .col-12.col-lg-10.mb-3.h-100(data-aos="zoom-in")
        .row.bg8.justify-content-start
          ...
          .col-9.align-items-center.p-3
            div
              p.mb-0 Es fundamental para la estrategia de publicidad.

    Separador 
    #t_3_2.titulo-segundo.color-acento-contenido(data-aos="zoom-in-left")
      h2 3.2 Variables para definir #[i insights]

    p(data-aos="fade-down").mb-5 No hay procesos “cerrados” o únicos en la definición de #[i insights], pues puede ser tan variado como el tipo de producto o servicio que se quiere promover. El desarrollo propuesto en este apartado incluye los siguientes momentos:
    .row.justify-content-center.align-items-center.mb-5           
      .col-lg-3.my-3(data-aos="fade-left")
        .tarjeta.bg13.p-4.h-100
          figure.mb-3
            img.img-t(src='@/assets/curso/temas/62.png').mx-auto
          h5.text-center Observación
          p.text-center Qué “le gustaría” al consumidor, sus sentimientos, necesidades, deseos y decisiones en un momento específico. 
      .col-lg-3.my-3(data-aos="fade-left")
        .tarjeta.bg13.p-4.h-100
          figure.mb-3
            img.img-t(src='@/assets/curso/temas/63.png').mx-auto
          h5.text-center Motivación 
          p.text-center Se identifica por qué o la justificación del consumidor para seleccionar el producto o hacer la compra. 
      ...
      .col-lg-3.my-3(data-aos="fade-right")
        .tarjeta.bg13.p-4.h-100
          figure.mb-3
            img.img-t(src='@/assets/curso/temas/65.png').mx-auto
    ...
    p(data-aos="fade-down").mb-5  Las funciones principales de las herramientas digitales son:

    img.img-t.img-a.mb-5(data-aos="zoom-in")(src='@/assets/curso/temas/69.svg', alt='')
          ...
          PasosA.color-acento-contenido(tipo="n")
            .row.justify-content-center.align-items-center
              .col-lg-6
                ...
                ul.lista-ul.ps-1(data-aos="fade-left")
                  ...
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 Writer (Open Office).
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 Documentos (Google).                 
              .col-lg-6
            ...
            .row.justify-content-center.align-items-center
              ...
              .col-lg-6.text-start.order-lg-2
                h4(data-aos="fade-right") Hoja de cálculo 
                p(data-aos="fade-right") Su función principal es generar planillas con balances, control de gastos, estados de cuenta, manejos contables, etc.
                ul.lista-ul.ps-1(data-aos="fade-right")
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 Excel (Office).
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 Calc (Open Office).
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 Hoja de cálculo (Google).                 
            .row.justify-content-center.align-items-center
              .col-lg-6
                h4(data-aos="fade-left") Bases de datos
                p(data-aos="fade-left") Permite la creación y administración de datos del usuario, control de inventarios, consulta de registros, entre otras aplicaciones.
                ul.lista-ul.ps-1(data-aos="fade-left")
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 Access (Office).
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 Base (Open Office).
            ...
            .row.justify-content-center.align-items-center
              ...
              .col-lg-6.text-start.order-lg-2
                h4(data-aos="fade-right") Presentaciones 
                p(data-aos="fade-right") Permite la creación de presentaciones basadas en diapositivas o slides para la exposición de información, gráficos, infografías, videos, animaciones, gráficos, etc.
                ul.lista-ul.ps-1(data-aos="fade-right")
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 PowerPoint (Office).
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 Impress (Open Office).
                  li 
                    i.fas.fa-check.color-v1
                    p.mb-0 Presentaciones (Google).                 
            .row.justify-content-center.align-items-center
              .col-lg-6
                h4(data-aos="fade-left") Videoconferencias y conversaciones en línea
                p(data-aos="fade-left") Son plataformas que permiten la comunicación audiovisual y bidireccional que se desarrolla en tiempo real y a distancia para establecer la conversación entre dos o más participantes. Estas plataformas cuentan con herramientas complementarias para el trabajo en equipo, ideación y Cocreación.
                .row.justify-content-center.align-items-center
                  .col-lg-4                
                    ul.lista-ul.ps-1(data-aos="fade-left")
                      li 
    ...
    p(data-aos="fade-down").mb-5 El siguiente video amplia el concepto de herramientas digitales y su impacto en el entorno de las personas, se invita a observarlo para ampliar sus conocimientos al respecto:                                                   

    h5.text-center(data-aos="fade-down").my-5 Concepto de herramientas digitales y su impacto
    ...
    .tarjeta.tarjeta--azul.p-5.mb-5(data-aos="fade-left")
      SlyderA(tipo="b")
        ...
        .row.justify-content-center.align-items-start.p-3
          .col-lg-8.mb-4.mb-md-0
            h4.mb-3 Escucha digital 
            p Hace referencia al seguimiento y análisis de las interacciones y conversaciones que sostiene la audiencia en un canal digital o en un segmento del mercado. Permite identificar oportunidades para conseguir nuevos públicos, alcanzar nuevos mercados y alinearse con diferentes tendencias comunicativas en estos canales; conocer, de forma cercana a un público y su relación con la marca, uso detallado del producto o el sentimiento que tiene hacia la organización. 

            p Facilita el desarrollo de otras acciones como programas de reputación, prevención de crisis, automatización de procesos de atención, mejoramiento de la comunicación con los públicos, entre otros.
          .col-lg-4
        ...
        .row.justify-content-center.align-items-start.p-3
          .col-lg-8.mb-4.mb-md-0
            h4.mb-3 Minería de datos 
            p Es un proceso que se realiza con la finalidad de encontrar patrones y correlaciones en conjuntos de datos y de esta forma, predecir resultados. En el caso de los canales digitales sirve para obtener la frecuencia y hábitos de compra de los usuarios según las categorías de productos, incluso obtener información del perfil sociodemográfico de cada cliente. 

            p Es posible anticiparse a determinados eventos, caídas del sistema, precompras o adquisición de productos, por ejemplo, en una promoción sería posible predecir cuáles serán los productos con mayor venta y a través de qué canales.
    ...
    p(data-aos="fade-down").mb-0 Estas herramientas no son efectivas por sí solas, deben integrarse para que el resultado sea más funcional y de alto valor. Es así como, realizando cruces de información de canales digitales con los telefónicos o físicos, se pueden generar análisis de datos más profundos para obtener una medida integral para la gestión de la experiencia del cliente.
</template>
